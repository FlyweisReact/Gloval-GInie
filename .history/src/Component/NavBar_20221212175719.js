    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          {phoneNum ? <h4 style={{textAlign : 'center' , fontFamily : 'Monument'}}>Phone Number :-  1245369870 </h4> : ""}
          {email ? <h4 style={{textAlign : 'center' ,fontFamily : 'Monument'}}>Email Address :-  Email@gmail.com </h4> : ""}
        </Modal.Body>
