  ...
  return (
    <>
      ...
      <div className="technI" style={{marginTop  : '5%'}}>
        ...
        <h6>
        Safety Information:
Not intended for use by pregnant or lactating women. If you are on any medication, consult your doctor before use. Avoid this if you are allergic.
Discontinue use and consult your doctor or healthcare professional if any adverse reaction occur. Keep out of reach of children. Store in a cool dry
place. Do not use if outer bottle seal is missing, torn or damaged in any way. There are no guarantees that every person using this product / service
will see the expected results for sure. Results depend on a lot of factors and the results may vary from person to person.
        </h6>
      </div>
    </>
  );
